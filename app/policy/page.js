...
export const metadata = {
  ...
  description: "Privacy policy for MyShop Lagos. Learn how we collect, use, and protect your personal information.",
};
...
export default function PrivacyPage() {
  return (
    <page badge="🔒 Privacy Document" title="Privacy <em>Policy</em>" updated="January 1, 2026" toc={TOC}>
