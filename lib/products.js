...
async function getClient() {
  ...
  return createClient(
    ...
    {
      global: {
        // Tell Next.js never to cache Supabase HTTP responses.
        // Without this, Next.js caches the fetch even with force-dynamic,
        // so pages keep showing stale product data after admin edits.
        fetch: (url, options = {}) =>
